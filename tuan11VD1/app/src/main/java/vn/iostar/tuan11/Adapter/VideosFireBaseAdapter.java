package vn.iostar.tuan11.Adapter;
...
import vn.iostar.tuan11.Model.Video1Model;
import vn.iostar.tuan11.R;
...
public class VideosFireBaseAdapter extends FirebaseRecyclerAdapter<Video1Model, VideosFireBaseAdapter.MyHolder> {
    ...
    public class MyHolder extends RecyclerView.ViewHolder {
        ...
        private ImageView imPerson, favorites, inShare, imMore;
        ...
        public MyHolder(@NonNull View itemView) {
            ...
            inShare = itemView.findViewById(R.id.inShare);
